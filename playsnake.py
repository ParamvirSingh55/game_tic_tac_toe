# PLAY SNAKE GAME USING PYTHON AND PYGAME 
...
red = pygame.Color(128, 0 ,0) #maroon color-gameover
green = pygame.Color(255, 0, 0) #red-snake
black = pygame.Color(0, 0, 0) #black-score
white = pygame.Color(0, 255, 255) #aqua-screen
brown = pygame.Color(0,100, 0) #green-food
...
def gameOver():
    ...
    GOsurf = myFont.render(' LOOSER GAME OVER !!!', True, red) # this is the surface where game over will display having 3 args : the message, antialiasing,and Color
